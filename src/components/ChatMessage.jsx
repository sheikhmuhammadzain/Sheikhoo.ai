  ...
  return (
    ...
    >
      <div className={cn(
        ...
        isBot ? 'bg-gray-800 text-gray-100 ml-4 rounded-tl-none' : 'bg-purple-600 text-white mr-4 rounded-tr-none'
      )}>
        <div className="flex items-center mb-2">
          ...
          <span className="ml-2 font-medium">{isBot ? 'Sheikhoo AI' : 'You'}</span>
